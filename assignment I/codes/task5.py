...
def write_students_csv(filename):
    ...
    students=[
        {"Name":"Aakriti","Roll Number":1,"marks":85},
        {"Name":"Binisha","Roll Number":8,"marks":65},
        {"Name":"Kirtan","Roll Number":22,"marks":45},
        {"Name":"Shubham","Roll Number":30,"marks":60}
    ]
    ...
    print("Successfuly writeen into the csv file")
...
# to read the marks and calculate average marks from the csv file. 
